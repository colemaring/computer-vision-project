...
root = tk.Tk()
root.geometry("610x600")  # Set the width to 500 pixels and the height to 300 pixels
root.title("GUI")
...
triggerbot_checkbox = tk.Checkbutton(root, text="triggerbot", variable=triggerbot, anchor='e')
...
triggerbot_slider_between_delay = tk.Scale(root, from_=0, to=1000, resolution=1, orient=tk.HORIZONTAL, label='triggerbot shoot delay between shots (ms)', length=300)
triggerbot_slider_between_delay.set(50)
triggerbot_slider_between_delay.grid(row=8, column=1, sticky='w')
...
aimHotkey.grid(row=10, column=1, sticky='e')
exitHotkeyLabel = tk.Label(root, text="Exit program hotkey:")
exitHotkeyLabel.grid(row=9, column=1, sticky='w')
